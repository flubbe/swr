...
extern std::atomic<std::uint64_t> profile_points_input;
extern std::atomic<std::uint64_t> profile_points_submitted;
extern std::atomic<std::uint64_t> profile_lines_input;
extern std::atomic<std::uint64_t> profile_lines_submitted;
...
extern std::atomic<std::uint64_t> profile_raster_small_quad_primitives;
extern std::atomic<std::uint64_t> profile_raster_small_quad_queued_primitives;
extern std::atomic<std::uint64_t> profile_raster_small_quad_empty_primitives;
extern std::atomic<std::uint64_t> profile_raster_small_quad_fallback_primitives;
extern std::atomic<std::uint64_t> profile_raster_small_quad_coverage_cycles;
extern std::atomic<std::uint64_t> profile_raster_small_quad_attribute_cycles;
extern std::atomic<std::uint64_t> profile_raster_small_quad_callback_cycles;
extern std::atomic<std::uint64_t> profile_raster_small_quad_store_cycles;
