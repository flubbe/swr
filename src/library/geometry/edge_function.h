...
struct edge_function
{
    ...
    edge_function(const edge_function&) = default;
    edge_function(edge_function&&) = default;

    /** Assignments. */
    edge_function& operator=(const edge_function&) = default;
    edge_function& operator=(edge_function&&) = default;

    /**
     * Construct the edge function from two points on a line.
     *
     * @param v0 First point on the line.
     * @param v1 Second point on the line.
     */
    edge_function(
      const ml::vec2& v0,
      const ml::vec2& v1)
    : v_diff{v1 - v0}
    {
         ...
         * may be given as the scalar product of the line direction v1-v0 with
...
/** Edge function for fixed-point numbers. */
struct edge_function_fixed
{
    ...
    /** Default constructors. */
    edge_function_fixed() = default;
    edge_function_fixed(const edge_function_fixed&) = default;
    edge_function_fixed(edge_function_fixed&&) = default;

    /** Assignments. */
    edge_function_fixed& operator=(const edge_function_fixed&) = default;
    edge_function_fixed& operator=(edge_function_fixed&&) = default;
     ...
     */
    edge_function_fixed(
      const ml::vec2_fixed<4>& v0,
      const ml::vec2_fixed<4>& v1)
    : v_diff{v1 - v0}
    {
        c = v0.area(v_diff);
    }
