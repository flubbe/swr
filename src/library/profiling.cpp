...
std::atomic<std::uint64_t> profile_points_input{0};
std::atomic<std::uint64_t> profile_points_submitted{0};
std::atomic<std::uint64_t> profile_lines_input{0};
std::atomic<std::uint64_t> profile_lines_submitted{0};
...
std::atomic<std::uint64_t> profile_raster_small_quad_primitives{0};
std::atomic<std::uint64_t> profile_raster_small_quad_queued_primitives{0};
std::atomic<std::uint64_t> profile_raster_small_quad_empty_primitives{0};
std::atomic<std::uint64_t> profile_raster_small_quad_fallback_primitives{0};
std::atomic<std::uint64_t> profile_raster_small_quad_coverage_cycles{0};
std::atomic<std::uint64_t> profile_raster_small_quad_attribute_cycles{0};
std::atomic<std::uint64_t> profile_raster_small_quad_callback_cycles{0};
std::atomic<std::uint64_t> profile_raster_small_quad_store_cycles{0};
